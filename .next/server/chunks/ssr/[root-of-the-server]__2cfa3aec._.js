...
"[project]/app/hooks/useLogin.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useLogin() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { setUser, setToken } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const login = async (data)=>{
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("https://admin-api.pay.importa.biz/api/auth/login", data, {
                headers: {
                    "Content-Type": "application/json",
                    Accept: "*/*",
                    "X-CSRF-TOKEN": ""
            ...
            if (response.status >= 200 && response.status < 300) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Login successful! Redirecting to dashboard...");
                setTimeout(()=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useLogin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/hooks/useLogin.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
function LoginForm() {
    const { login, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useLogin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLogin"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cfa3aec._.js.map